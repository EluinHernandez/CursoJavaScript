...
let {name2, age2, alias2, email = "daschhernandez@gmail.com"} = person
console.log(name2) // No existe
console.log(age2) // No existe
console.log(alias2) // No existe
console.log(email)

// Sintaxis objects con nuevos nombre de variables
...
let person5 = {...person, email : "daschhernandez@gmail.com"}
console.log(person5)